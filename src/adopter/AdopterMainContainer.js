...
class AdopterMainContainer extends React.Component {
  ...
  //once you remove the Click to see dogs button you can get rid of this
  renderDogs = () => {
  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* {this.state.showDogs ? this.renderDogs() : <button onClick={this.showDogs}>Click to see some dogs!</button>} */}
        <br/>
        ...
        {/* <Switch>
          <Route path="/adopter/matt" render={()=><div>Hi matt</div>} />
